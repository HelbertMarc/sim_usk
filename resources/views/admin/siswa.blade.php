...
<div class="card mb-4">
    <div class="card-header">
        ...
        DataTable Siswa &nbsp;
        <button data-bs-toggle="modal" data-bs-target="#siswa">Tambah</button>
    </div>
    <div class="card-body">
        <form role="search" method="get" action="/admin/siswa">
            @csrf Cari data &nbsp;<input type="text" name="search" class="form-control dinline" id="search" placeholder="Masukkan NIS" maxlength="10" style="width: 150px; height: 32px; border-radius: 4px; -moz-border-radius: 4px;" />
            ...
            <table class="table table-hover table-borderless" id="datatablesSimple">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $dt->kelas }}</td>
                        <td>
                            <a class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#ubah{{ $dt->id }}">
                                Ubah
                            </a>
...
<div class="modal fade" id="siswa" tabindex="-1" data-bs-backdrop="static" data- bs-keyboard="false" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
@foreach ($data as $dt)
<!-- Modal Hapus -->
<div class="modal fade" id="hapus{{ $dt->id }}" tabindex="-1"
...
<div class="modal fade" id="ubah{{ $dt->id }}" tabindex="-1" data-bs-
    backdrop="static"
    ...
    <div class="modal-body">
    <form id="create-depot-form" action="/admin/siswa/{{ $dt->id }}"
    method="POST">
    @csrf
    @method('PUT')
    <div class="row g-1">
