...
<div class="card mb-4">
    <div class="card-header">
        ...
        DataTable Petugas &nbsp;<button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#regis">Tambah</button>
    </div>
    <div class="card-body">
        @if ($data->isNotEmpty())
            ...
            <table class="table table-hover table-borderless" id="datatablesSimple">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $dt->level }}</td>
                        <td>
                            <button class="btn btn-warning btn-sm" href="/admin/petugas/edit/{{ $dt->id }}" data-bs-toggle="modal" data-bs-target="#ubah{{$dt->id}}">
                                Ubah
                            </button>
                            <button class="btn btn-danger btn-sm" href="/admin/petugas/delete/{{ $dt->id }}" data-bs-toggle="modal" data-bs-target="#hapus{{$dt->id}}">Hapus</button>
                        </td>
                    </tr>
                    <!-- Modal Hapus -->
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h4 class="text-center">
                    Apakah anda yakin menghapus petugas
                    <span><font color="blue">{{$dt->nama}} </font></span>
                </h4>
            </div>
            <div class="modal-footer">
...
<a class="btn btn-warning btn-sm" href="/admin/siswa/edit/{{ $dt->id }}"
    data-bs-toggle="modal" data-bs-target="#ubah{{ $dt->id }}">Ubah</a>
    <a class="btn btn-danger btn-sm" href="/admin/siswa/delete/{{ $dt->id }}"
    data-bs-toggle="modal" data-bs-target="#hapus{{ $dt->id }}">Hapus</a>
<!-- Modal ubah -->
