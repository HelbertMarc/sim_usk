...
<center><h2>DataTable Pelanggaran &nbsp;
    <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#pelanggaran">
        Tambah</button>
    <a class="btn btn-warning btn-sm" href="{{ url('guru/pelanggaran-pdf') }}" target="_blank">Cetak</a>
</h2></center>
@if ($data->isNotEmpty())
<table class="table">
<thead>
